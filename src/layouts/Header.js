      ...
      >
        ...
        >
          <ul className="flex items-center space-x-3">
            <li className='hover:cursor-pointer border-b px-1'>
            ...
            <li className='hover:cursor-pointer border-b px-1 animate-pulse'>
              <a className='text-sm xs:text-base flex items-center gap-1'>
                Resume
                <Iconify icon="humbleicons:download" classes='text-xl' />
              </a>
            </li>
            <li>
              <button
